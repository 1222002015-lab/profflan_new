...
export const DOCUMENT_REQUIREMENTS: { [key: string]: string[] } = {
  ...
  "Layanan Kenaikan Jenjang Jabatan Fungsional": ["Surat usulan", "SK jabatan & pangkat terakhir", "PAK"],
  "Layanan Pengangkatan Kembali ke dalam Jabatan Fungsional": [
    "Surat permohonan",
    "SK jabatan sebelumnya",
    "Bukti pengalaman",
    "PAK terakhir",
    "Rekomendasi teknis",
  ],
  ...
  "Layanan Penugasan PNS pada Instansi Pemerintah dan di Luar Instansi": [
    ...
    "Kartu pegawai",
    "SKP 1 tahun terakhir",
    "Surat persetujuan instansi penerima",
    "Surat pernyataan tidak dalam hukuman disiplin",
  ],
  "Layanan Izin untuk Melakukan Perceraian PNS": [
    "Surat permohonan",
    "Fotokopi akta nikah",
    "Surat rekomendasi (BKKBN/KUA/Pemuka agama)",
    "Berita acara pemeriksaan",
    "Bukti alasan perceraian",
    "Surat pernyataan pembagian gaji",
  ],
  "Layanan Fasilitasi Penganugerahan Tanda Kehormatan oleh Presiden": [
    "Surat usul ke Menteri",
    "Daftar riwayat hidup",
    "Uraian jasa",
    "Publikasi/naskah akademik",
    "Rekomendasi unit kerja",
    "Dokumen bebas masalah hukum",
  ],
  "Layanan Cuti di Luar Tanggungan Negara (CLTN)": [
  ...
  "Layanan Kartu Istri/Kartu Suami": [
    ...
    "Akte nikah",
    "Laporan perkawinan",
    "Akte cerai (Jika pernikahan Ke-2)",
    "Akta Kematian Pasangan (Jika Menikah Kembali)",
  ],
  "Layanan Permintaan Data Kepegawaian SIMPEG": [
    "Surat permohonan resmi",
    "Format & jenis data diminta",
    "Maksud & tujuan penggunaan data",
    "Pejabat penanggung jawab",
  ],
  "Layanan Ralat Nama/NIP pada Aplikasi SIMPEG/SIASN": [
    "Surat permohonan KSBTU/Bagian TU",
    "Soft file ijazah",
    "SK CPNS",
    "SK PNS",
    "SK Pangkat terakhir",
    "Pertek BKN konversi NIP",
  ],
  "Layanan Pelatihan Kepemimpinan": [
    "Surat usul unit",
    "SK Jabatan",
    "Surat pemberitahuan Diklat dari LAN",
    "Syarat tambahan dari penyelenggara",
    "Surat tugas & penunjukan mentor",
  ],
  "Layanan Pengelolaan LHKPN": ["Surat permohonan", "Formulir LHKPN", "Daftar harta kekayaan", "Dokumen pendukung"],
  "Layanan Sosialisasi Kebijakan Bidang SDM dan Organisasi": [
    "Surat permintaan sosialisasi dari unit kerja",
    "Daftar peserta",
    "Jadwal kegiatan",
  ],
  "Layanan Perpindahan Jabatan": [
    ...
    "PAK",
    "Surat pernyataan tidak dalam hukuman disiplin",
    "Rekomendasi pejabat pembina",
  ],
  "Layanan Pemberhentian Jabatan Fungsional": [
    "Surat usul pemberhentian",
    "SK Jabatan terakhir",
    "SK Pangkat terakhir",
    "PAK terakhir",
